...
# evaluate error at different noise levels
N_freq = 60
arr_w_FourierWSINDy = np.zeros((w_true.shape[0],w_true.shape[1],len(arr_sig_NR),N_noise))
...
for i in range(0,len(arr_sig_NR)):
    for j in range(0,N_noise):
        ...
        arr_w_FourierWSINDy[:,:,i,j] = w_ident
...
data["arr_w_FourierWSINDy"] = arr_w_FourierWSINDy
...
savemat("results_noiseLevelAndCoeffs_Lorenz.mat",data)